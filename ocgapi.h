...
typedef uint8_t* (*script_reader)(const char* script_name, int* len);
...
OCGCORE_API int32_t get_message(intptr_t pduel, uint8_t* buf);
...
OCGCORE_API int32_t query_card(intptr_t pduel, uint8_t playerid, uint8_t location, uint8_t sequence, uint32_t query_flag, uint8_t* buf, int32_t use_cache);
OCGCORE_API int32_t query_field_count(intptr_t pduel, uint8_t playerid, uint8_t location);
OCGCORE_API int32_t query_field_card(intptr_t pduel, uint8_t playerid, uint8_t location, uint32_t query_flag, uint8_t* buf, int32_t use_cache);
OCGCORE_API int32_t query_field_info(intptr_t pduel, uint8_t* buf);
OCGCORE_API void set_responsei(intptr_t pduel, int32_t value);
OCGCORE_API void set_responseb(intptr_t pduel, uint8_t* buf);
OCGCORE_API int32_t preload_script(intptr_t pduel, const char* script_name);
OCGCORE_API uint8_t* default_script_reader(const char* script_name, int* len);

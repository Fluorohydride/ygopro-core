...
public:
	...
	int32_t is_capable_send_to_deck(uint8 playerid, uint8 send_activating = FALSE);
	int32_t is_capable_send_to_extra(uint8 playerid);
	int32_t is_capable_cost_to_grave(uint8 playerid);
	int32_t is_capable_cost_to_hand(uint8 playerid);
	int32_t is_capable_cost_to_deck(uint8 playerid);
	int32_t is_capable_cost_to_extra(uint8 playerid);
	int32_t is_capable_attack();
	int32_t is_capable_attack_announce(uint8 playerid);
	int32_t is_capable_change_position(uint8 playerid);

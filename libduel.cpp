...
int32 scriptlib::duel_pendulum_summon(lua_State *L) {
	...
	if(!lua_isnil(L, 2)) {
		...
		pendulums = pduel->new_group(pgroup->container);
		pendulums->is_readonly = TRUE;
	}
...
static const struct luaL_Reg duellib[] = {
	...
	{ "GetAdditionalPendulumSummon", scriptlib::duel_get_additional_p_summon },
	{ "SetAdditionalPendulumSummon", scriptlib::duel_set_additional_p_summon },
	...
	{ "IsPlayerCanAdditionalPendulumSummon", scriptlib::duel_is_player_can_additional_p_summon },

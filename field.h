...
public:
	...
	int32 check_discard_hand(uint8 playerid, int32 findex, int32 min, uint32 reason, card* exp, uint32 exarg);
	...
	int32 discard_hand(uint16 step, uint8 playerid, uint16 min, uint16 max, uint32 reason);

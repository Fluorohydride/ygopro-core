...
public:
	...
	int32 check_lp_cost(uint8 playerid, uint32 cost, uint32 must_pay, uint32 reason);
	void save_lp_cost() {}
	void restore_lp_cost() {}
	int32 pay_lp_cost(uint32 step, uint8 playerid, uint32 cost, uint32 must_pay, uint32 reason);

...
public:
	...
	int32 get_summon_release_list(card* target, card_set* release_list, card_set* ex_list, card_set* ex_list_oneof, group* mg = NULL, uint32 ex = 0, uint32 releasable = 0xff00ff, int32 min = 1, int32 max = 12, uint32 pos = 0x1);
